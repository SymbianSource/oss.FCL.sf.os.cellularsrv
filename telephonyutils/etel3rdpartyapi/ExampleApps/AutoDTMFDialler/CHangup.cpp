...
/**
Checks the status of the active object and if there is no error,
tells the user via the console that the call has been hung up.
*/
void CHangup::RunL()
	{
	if(iStatus != KErrNone)
		...
		{
		// Print output to console if there is no error
