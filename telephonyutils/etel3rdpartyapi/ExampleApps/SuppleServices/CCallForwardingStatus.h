...
private:
	...
	*/
	...
	status is CTelephony::ECallForwardingUnconditional
	When set to ETrue, DoStartRequestL() will check if the call forwarding
	status is CTelephony::ECallForwardingNoReply
	*/
