...
ESock::MLowerDataSender* CIPv4Binder::Bind(ESock::MUpperDataReceiver* aUpperReceiver, ESock::MUpperControl* aUpperControl)
/**
...
ESock::MLowerDataSender::TSendResult CIPv4Binder::Send(RMBufChain& aPdu)
	{
	return Send(static_cast<RCommsBufChain&>(aPdu));
	}

ESock::MLowerDataSender::TSendResult CIPv4Binder::Send(RCommsBufChain& aPdu)
/**
...
void CIPv4Binder::Process(RCommsBufChain& aPdu)
/**
