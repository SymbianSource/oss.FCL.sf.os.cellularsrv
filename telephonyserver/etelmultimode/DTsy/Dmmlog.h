...
#ifdef __LOGGER__
#define LOGTEXTREL(AAA)	CDTSYLogger::Write(AAA)
#else
#define LOGTEXTREL(AAA)
#endif

#ifdef __LOGGER__
#define LOGTEXTREL2(AAA,BBB)	CDTSYLogger::WriteFormat(TRefByValue<const TDesC8>(AAA),BBB)
#else
#define LOGTEXTREL2(AAA,BBB)
#endif

#ifdef __LOGGER__
#define LOGTEXTREL3(AAA,BBB,CCC)	CDTSYLogger::WriteFormat(TRefByValue<const TDesC8>(AAA),BBB,CCC)
#else
#define LOGTEXTREL3(AAA,BBB,CCC)
#endif
