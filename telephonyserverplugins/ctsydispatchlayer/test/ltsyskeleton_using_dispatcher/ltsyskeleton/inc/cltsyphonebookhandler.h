...
public:
	...
	static CLtsyPhonebookHandler* NewL(CCtsyDispatcherCallback& aCtsyDispatcherCallback);
	static CLtsyPhonebookHandler* NewLC(CCtsyDispatcherCallback& aCtsyDispatcherCallback);
...
private:
	...
	CLtsyPhonebookHandler(CCtsyDispatcherCallback& aCtsyDispatcherCallback);
	void ConstructL();
