...
class CMockCellBroadcastMessHandler : public CBase, public MMockMessHandlerBase
    {
public: 
	static CMockCellBroadcastMessHandler* NewL(CMockLtsyEngine& aEngine, CCtsyDispatcherCallback& aCallback);
	virtual ~CMockCellBroadcastMessHandler();
...
private: 
 	CMockCellBroadcastMessHandler(CMockLtsyEngine& aEngine, CCtsyDispatcherCallback& aCallback);
	void ConstructL();
...
#endif // CMOCKCELLBROADCASTMESSHANDLER_H
