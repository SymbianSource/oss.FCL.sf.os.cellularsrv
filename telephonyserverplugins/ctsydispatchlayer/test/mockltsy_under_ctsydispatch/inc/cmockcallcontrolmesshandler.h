...
class CMockCallControlMessHandler : public CBase, public MMockMessHandlerBase
    {
public: 
	static CMockCallControlMessHandler* NewL(CMockLtsyEngine& aEngine, CCtsyDispatcherCallback& aCallback);
	virtual ~CMockCallControlMessHandler();
...
private: 
 	CMockCallControlMessHandler(CMockLtsyEngine& aEngine, CCtsyDispatcherCallback& aCallback);
	void ConstructL();
...
#endif // CMOCKCALLCONTROLMESSHANDLER_H
