...
class CMockSecurityMessHandler : public CBase, public MMockMessHandlerBase
    {
public: 
	static CMockSecurityMessHandler* NewL(CMockLtsyEngine& aEngine, CCtsyDispatcherCallback& aCallback);
	virtual ~CMockSecurityMessHandler();
...
private: 
 	CMockSecurityMessHandler(CMockLtsyEngine& aEngine, CCtsyDispatcherCallback& aCallback);
	void ConstructL();
...
#endif // CMOCKSECURITYMESSHANDLER_H
