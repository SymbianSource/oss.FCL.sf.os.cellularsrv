...
class CMockPhonebookOnMessHandler : public CBase, public MMockMessHandlerBase
    {
public: 
	static CMockPhonebookOnMessHandler* NewL(CMockLtsyEngine& aEngine, CCtsyDispatcherCallback& aCallback);
	virtual ~CMockPhonebookOnMessHandler();
...
private: 
 	CMockPhonebookOnMessHandler(CMockLtsyEngine& aEngine, CCtsyDispatcherCallback& aCallback);
	void ConstructL();
...
#endif // CMOCKPHONEBOOKONMESSHANDLER_H
