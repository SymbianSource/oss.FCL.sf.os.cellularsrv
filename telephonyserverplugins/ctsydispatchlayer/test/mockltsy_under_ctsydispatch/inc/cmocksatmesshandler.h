...
class CMockSatMessHandler : public CBase, public MMockMessHandlerBase
    {
public: 
	static CMockSatMessHandler* NewL(CMockLtsyEngine& aEngine, CCtsyDispatcherCallback& aCallback);
	virtual ~CMockSatMessHandler();
...
private: 
 	CMockSatMessHandler(CMockLtsyEngine& aEngine, CCtsyDispatcherCallback& aCallback);
	void ConstructL();
