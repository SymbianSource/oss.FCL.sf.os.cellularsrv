...
class CMockPhonebookEnMessHandler : public CBase, public MMockMessHandlerBase
    {
public: 
	static CMockPhonebookEnMessHandler* NewL(CMockLtsyEngine& aEngine, CCtsyDispatcherCallback& aCallback);
	virtual ~CMockPhonebookEnMessHandler();
...
private: 
 	CMockPhonebookEnMessHandler(CMockLtsyEngine& aEngine, CCtsyDispatcherCallback& aCallback);
	void ConstructL();
...
#endif // CMOCKPHONEBOOKENMESSHANDLER_H
