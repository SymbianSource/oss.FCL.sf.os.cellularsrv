...
#ifndef CSATNOTIFYRECEIVEDATA_H
#define CSATNOTIFYRECEIVEDATA_H
...
/**
* DESCRIPTION
* SAT Notify ReceiveData notification class.
* Created when client requests to be notified when ReceiveData
...
* @since 3.1
*/
NONSHARABLE_CLASS ( CSatNotifyReceiveData ) : 	public CBase,
    ...
    public: // Constructors and destructor
        ...
        * return CSatNotifyReceiveData*: created object 
        */
        static CSatNotifyReceiveData* NewL( 
    ...
    public: // Functions from base classes
        ...
        */
        ...
        /**
        * Cancels notification request about receive data.
        ...
        */
        ...
        /**
        * Handles the Receive data terminal response
    ...
    private: // Data
        ...
        // Notify ReceiveData struct. Package received from ETel.
