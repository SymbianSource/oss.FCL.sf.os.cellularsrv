...
#ifndef __CSMSDELETE_H__
#define __CSMSDELETE_H__

#include "Te_LoopbackTestStepBase.h"
#include "Te_LoopBackScriptEng.h"

const TUint8 KTestPduF[]= {
...
const TUint8 KTestPduG[]= {
						   0x04, 0x0c, 0x91, 0x44, 0x77, 0x74, 0x60, 0x45, 0x61, 0x00, 0x00, 0x00, 0x30,
						   0x71, 0x61, 0x03, 0x52, 0x00, 0x0a, 0xd4, 0xf2, 0x9c, 0x9e, 0x76, 0x9f, 0x5d,
						   0x2e, 0x17 };


const struct TScript KDeleteSmsScript[]= {
...
//
	...
	{	ERxString, (TText8*)"AT+CPMS?",	0, ERxEvent	},
	{	ETxString, (TText8*)"+CPMS: \"MT\",0,15,\"MT\",0,15\r",	0, ETxEvent|EFailIfTimeOut	},
	{	ETxStringOK, NULL,					0, ETxEvent|EFailIfTimeOut	},

	{	ERxString, (TText8*)"AT+CMGW = 26",	0, ERxEvent	},
	{	ETxStringOK, NULL,					0, ETxEvent|EFailIfTimeOut	},

	{	ERxString, (TText8*)"3232323231323334353637383939383736353433323132323232\x1A",
								0, ERxEvent|EFailIfTimeOut	},
	{	ETxStringOK, NULL,					0, ETxEvent|EFailIfTimeOut	},

	{	ERxString, (TText8*)"AT+CMGW = 26",	0, ERxEvent	},
	{	ETxStringOK, NULL,					0, ETxEvent|EFailIfTimeOut	},

	{	ERxString, (TText8*)"003232323231323334353637383939383736353433323132323232\x1A",
								0, ERxEvent|EFailIfTimeOut	},
	{	ETxString, (TText8*)"\r+CMGW: 2",	0, ETxEvent|EFailIfTimeOut	},
	{	ETxStringOK, NULL,					0, ETxEvent|EFailIfTimeOut	},
	...
	{	ERxString, (TText8*)"AT+CMGD=1",	0, ERxEvent	},
	{	ETxStringOK, NULL,					0, ETxEvent|EFailIfTimeOut	}, 
...
//
class CTestDriveSmsDelete : public CTestBase
		{
	public:
		static CTestDriveSmsDelete* NewL(const TScriptList aScriptListEntry);
		~CTestDriveSmsDelete();
	...
	private:
		CTestDriveSmsDelete(const TScriptList aScriptListEntry);
		void TestSmsDeleteL(RMobileSmsStore& aSmsSimStore);
...
class CTestSmsDelMess : public CATScriptEng
		{
	public:
		static CTestSmsDelMess* NewL(const TScript* aScript);
		~CTestSmsDelMess();
	...
	private:
		CTestSmsDelMess(const TScript* aScript);
		void ConstructL();
