...
namespace te_c32BcaUnitTests
	{
	// Misc. utility typedefs
	typedef TBufC<128> TPortNameBuf;
	typedef TBuf<128> TControlBuf;
	...
	*/
	...
	/** 
	C32Bca Test Proxy
	Encapsulates C32Bca specific functionality */	
	class CC32BcaProxy: 
		public CBcaTestProxy
		{
		public:
			static CC32BcaProxy* NewL(CTestStep& aLogger, const TDesC& aProxyName);
			void Release();
			
		protected:
			CC32BcaProxy(CTestStep& aLogger, const TDesC& aProxyName);
			void ConstructL();
