...
TBool CT_RMmCustomApiData::DoCommandL(const TTEFFunction& aCommand, const TTEFSectionName& aSection, const TInt aAsyncErrorIndex)
	...
	if ( aCommand==KCmdModeCheck )
		{
		UtilityModeCheck(aSection);
		}
...
/**
 * Gets the current Network Mode of the Phone.
 */
 ...
 */
void CT_RMmCustomApiData::UtilityModeCheck(const TTEFSectionName& aSection)
	{    
